// Application 1 — design tokens
// Import this everywhere. Never hardcode a hex value in a screen or component.
...
export const type = {
  ...
  screenGreeting: { fontFamily: fonts.display, fontSize: 26 },
  eyebrow: {
    fontFamily: fonts.bodyRegular,
    fontSize: 11,
    letterSpacing: 0.9, // ~0.07em at 11px, adjust per platform if needed
  ...
  stampLabel: { fontFamily: fonts.mono, fontSize: 9, letterSpacing: 0.3, lineHeight: 10 },
} as const;
